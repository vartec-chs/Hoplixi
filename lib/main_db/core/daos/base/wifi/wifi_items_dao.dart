...
class WifiItemsDao extends DatabaseAccessor<MainStore>
  ...
  Future<int> updateWifiByItemId(String itemId, WifiItemsCompanion companion) {
    return (update(
      wifiItems,

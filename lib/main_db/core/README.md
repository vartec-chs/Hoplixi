...
участниками команды. После внесения изменений в структуру баз данных, логику DAO
или сервисов, пожалуйста,обновляйте этот документ, чтобы он отражал текущую
реализацию.

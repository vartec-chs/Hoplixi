...
const List<String> _schemaChanges = [
  ...
  'ALTER TABLE vault_item_history ADD COLUMN category_history_id TEXT NULL REFERENCES item_category_history(id) ON DELETE SET NULL;',
  'ALTER TABLE file_metadata ADD COLUMN is_missing INTEGER NOT NULL DEFAULT 0;',
  'ALTER TABLE file_metadata ADD COLUMN is_deleted INTEGER NOT NULL DEFAULT 0;',
  'ALTER TABLE file_metadata ADD COLUMN missing_detected_at INTEGER NULL;',
  'ALTER TABLE file_metadata ADD COLUMN deleted_at INTEGER NULL;',
  'ALTER TABLE file_metadata ADD COLUMN last_known_path TEXT NULL;',
  'ALTER TABLE file_metadata ADD COLUMN last_integrity_check_at INTEGER NULL;',
  'ALTER TABLE file_metadata ADD COLUMN integrity_status TEXT NOT NULL DEFAULT \'unknown\';',
...
const List<String> _documentSnapshotIndexes = [
  ...
  'CREATE INDEX IF NOT EXISTS idx_file_metadata_integrity_status ON file_metadata(integrity_status);',
  'CREATE INDEX IF NOT EXISTS idx_file_metadata_last_integrity_check_at ON file_metadata(last_integrity_check_at);',
  ...
  'CREATE INDEX IF NOT EXISTS idx_vault_item_history_category_history_id ON vault_item_history(category_history_id);',

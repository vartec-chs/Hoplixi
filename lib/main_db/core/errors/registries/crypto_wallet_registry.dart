...
final Map<String, DbConstraintDescriptor> cryptoWalletRegistry = {
  CryptoWalletItemConstraint.itemIdNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  CryptoWalletItemConstraint.walletContentRequired.constraintName: const DbConstraintDescriptor(
  ...
  CryptoWalletItemConstraint.addressesNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  CryptoWalletItemConstraint.hardwareDeviceNotBlank.constraintName: const DbConstraintDescriptor(

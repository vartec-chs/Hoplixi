...
final Map<String, DbConstraintDescriptor> identityRegistry = {
  IdentityItemConstraint.itemIdNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  IdentityItemConstraint.atLeastOneIdentifyingField.constraintName: const DbConstraintDescriptor(

...
final Map<String, DbConstraintDescriptor> bankCardRegistry = {
  BankCardItemConstraint.itemIdNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  BankCardItemConstraint.cardholderNameNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  BankCardItemConstraint.cardNumberNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  BankCardItemConstraint.cardTypeOtherRequired.constraintName: const DbConstraintDescriptor(
  ...
  BankCardItemConstraint.cardNetworkOtherRequired.constraintName: const DbConstraintDescriptor(
  ...
  BankCardItemConstraint.expiryMonthValid.constraintName: const DbConstraintDescriptor(
  ...
  BankCardItemConstraint.expiryYearValid.constraintName: const DbConstraintDescriptor(
  ...
  BankCardItemConstraint.cvvNotBlank.constraintName: const DbConstraintDescriptor(

...
final Map<String, DbConstraintDescriptor> licenseKeyRegistry = {
  LicenseKeyItemConstraint.itemIdNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  LicenseKeyItemConstraint.licenseKeyNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  LicenseKeyItemConstraint.productNameNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  LicenseKeyItemConstraint.accountEmailNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  LicenseKeyItemConstraint.licenseTypeOtherRequired.constraintName: const DbConstraintDescriptor(

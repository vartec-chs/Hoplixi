...
final Map<String, DbConstraintDescriptor> noteRegistry = {
  NoteItemConstraint.itemIdNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  NoteItemConstraint.contentNotBlank.constraintName: const DbConstraintDescriptor(

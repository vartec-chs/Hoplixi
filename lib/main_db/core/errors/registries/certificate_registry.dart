...
final Map<String, DbConstraintDescriptor> certificateRegistry = {
  CertificateItemConstraint.itemIdNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  CertificateItemConstraint.certificateContentRequired.constraintName: const DbConstraintDescriptor(
  ...
  CertificateItemConstraint.certificatePemNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  CertificateItemConstraint.pemFormatRequiresPem.constraintName: const DbConstraintDescriptor(
  ...
  CertificateItemConstraint.binaryFormatRequiresBlob.constraintName: const DbConstraintDescriptor(
  ...
  CertificateItemConstraint.keySizePositive.constraintName: const DbConstraintDescriptor(
  ...
  CertificateItemConstraint.serialNumberNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  CertificateItemConstraint.issuerNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  CertificateItemConstraint.subjectNotBlank.constraintName: const DbConstraintDescriptor(
  ...
  CertificateItemConstraint.validRange.constraintName: const DbConstraintDescriptor(

...
final Map<String, DbConstraintDescriptor> fileRegistry = {
  // --- File Items ---
  FileItemConstraint.itemIdNotBlank.constraintName:
  ...
  FileItemConstraint.metadataIdNotBlank.constraintName:
      const DbConstraintDescriptor(
  ...
  // --- File Metadata ---
  FileMetadataConstraint.idNotBlank.constraintName:
      const DbConstraintDescriptor(
  ...
  FileMetadataConstraint.fileNameNotBlank.constraintName:
      const DbConstraintDescriptor(
  ...
  FileMetadataConstraint.fileSizeNonNegative.constraintName:
      const DbConstraintDescriptor(
  ...
  FileMetadataConstraint.sha256Length.constraintName:
      const DbConstraintDescriptor(
  ...
  FileMetadataConstraint.integrityRequiresAvailable.constraintName:
      const DbConstraintDescriptor(

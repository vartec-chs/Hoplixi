...
enum CertificateHistoryConstraint {
  certificateContentRequired(
    'chk_certificate_history_content_required',
  ),

  certificatePemNotBlank(
    'chk_certificate_history_certificate_pem_not_blank',
  ),
  ...
  keySizePositive(
    'chk_certificate_history_key_size_positive',
  ),

  serialNumberNotBlank(
    'chk_certificate_history_serial_number_not_blank',
  ),

  issuerNotBlank(
    'chk_certificate_history_issuer_not_blank',
  ),

  subjectNotBlank(
    'chk_certificate_history_subject_not_blank',
  ),

  validRange(
    'chk_certificate_history_valid_range',
  ),

  ocspUrlNotBlank(
    'chk_certificate_history_ocsp_url_not_blank',
  ),

  crlUrlNotBlank(
    'chk_certificate_history_crl_url_not_blank',
  );

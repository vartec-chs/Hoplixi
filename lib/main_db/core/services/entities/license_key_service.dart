...
class LicenseKeyService {
  ...
  Future<String> create(CreateLicenseKeyDto dto) async {
    return await db.transaction(() async {
      ...
      if (createdView == null) {
        throw Exception('Failed to retrieve created LicenseKey: $itemId');
      }
  ...
  Future<void> update(PatchLicenseKeyDto dto) async {
    await db.transaction(() async {
      final itemId = dto.item.itemId;

      final oldView = await repository.getViewById(itemId);
      if (oldView == null) {
        throw Exception('LicenseKey not found for update: $itemId');
      }

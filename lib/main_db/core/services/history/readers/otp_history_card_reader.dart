...
class OtpHistoryCardReader implements VaultHistoryTypeReader {
  OtpHistoryCardReader({required this.otpHistoryDao});
  ...
  Future<Map<String, VaultHistoryCardDto>> getCardsBySnapshots(
    ...
    final dataByHistoryId = await otpHistoryDao
        .getOtpHistoryCardDataByHistoryIds(historyIds);
    ...
    for (final snapshot in snapshots) {
      ...
      result[snapshot.id] = data == null
          ...
          : OtpHistoryCardDto(snapshot: snapshotDto, otp: data);
    }

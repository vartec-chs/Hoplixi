...
class NoteHistoryCardReader implements VaultHistoryTypeReader {
  NoteHistoryCardReader({required this.noteHistoryDao});
  ...
  Future<Map<String, VaultHistoryCardDto>> getCardsBySnapshots(
    ...
    final dataByHistoryId = await noteHistoryDao
        .getNoteHistoryCardDataByHistoryIds(historyIds);
    ...
    for (final snapshot in snapshots) {
      ...
      result[snapshot.id] = data == null
          ...
          : NoteHistoryCardDto(snapshot: snapshotDto, note: data);
    }

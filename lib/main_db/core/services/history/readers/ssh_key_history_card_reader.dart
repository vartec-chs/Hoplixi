...
class SshKeyHistoryCardReader implements VaultHistoryTypeReader {
  SshKeyHistoryCardReader({required this.sshKeyHistoryDao});
  ...
  Future<Map<String, VaultHistoryCardDto>> getCardsBySnapshots(
    ...
    final dataByHistoryId = await sshKeyHistoryDao
        .getSshKeyHistoryCardDataByHistoryIds(historyIds);

...
class LicenseKeyHistoryCardReader implements VaultHistoryTypeReader {
  LicenseKeyHistoryCardReader({required this.licenseKeyHistoryDao});
  ...
  Future<Map<String, VaultHistoryCardDto>> getCardsBySnapshots(
    ...
    final dataByHistoryId = await licenseKeyHistoryDao
        .getLicenseKeyHistoryCardDataByHistoryIds(historyIds);

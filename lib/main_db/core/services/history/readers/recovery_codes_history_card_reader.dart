...
class RecoveryCodesHistoryCardReader implements VaultHistoryTypeReader {
  RecoveryCodesHistoryCardReader({required this.recoveryCodesHistoryDao});
  ...
  Future<Map<String, VaultHistoryCardDto>> getCardsBySnapshots(
    ...
    final dataByHistoryId = await recoveryCodesHistoryDao
        .getRecoveryCodesHistoryCardDataByHistoryIds(historyIds);

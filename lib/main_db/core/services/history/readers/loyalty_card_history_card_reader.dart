...
class LoyaltyCardHistoryCardReader implements VaultHistoryTypeReader {
  LoyaltyCardHistoryCardReader({required this.loyaltyCardHistoryDao});
  ...
  Future<Map<String, VaultHistoryCardDto>> getCardsBySnapshots(
    ...
    final dataByHistoryId = await loyaltyCardHistoryDao
        .getLoyaltyCardHistoryCardDataByHistoryIds(historyIds);
    ...
    for (final snapshot in snapshots) {
      ...
      result[snapshot.id] = data == null
          ...
          : LoyaltyCardHistoryCardDto(snapshot: snapshotDto, loyaltycard: data);
    }

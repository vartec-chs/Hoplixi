      ...
      return await db.transaction(() async {
        ...
        switch (snapshot.type) {
            ...
            if (fields['service'] == null || fields['key'] == null) {
              return const Failure(
                DBCoreError.conflict(
                  ...
                  message:
                      'Нельзя восстановить запись: в снимке отсутствуют обязательные поля API Key',
                  entity: 'apiKey',
                ),
              );
            }
          ...
          case VaultItemType.recoveryCodes:
            ...
            if (fields['codesCount'] != null &&
                (fields['codesCount'] as int) > 0 &&
                values.isEmpty) {
              return const Failure(
                DBCoreError.conflict(
        ...
        switch (snapshot.type) {
            ...
            await apiKeyItemsDao.upsertApiKeyItem(
              ApiKeyItemsCompanion(
                ...
                tokenType: Value(
                  tokenTypeName == null
                      ? null
                      : ApiKeyTokenType.values.byName(tokenTypeName),
                ),
                environment: Value(
                  environmentName == null
                      ? null
                      : ApiKeyEnvironment.values.byName(environmentName),
                ),
            ...
            await bankCardItemsDao.upsertBankCardItem(
              BankCardItemsCompanion(
                ...
                cardType: Value(
                  cardTypeName == null
                      ? null
                      : CardType.values.byName(cardTypeName),
                ),
                cardTypeOther: Value(fields['cardTypeOther'] as String?),
                cardNetwork: Value(
                  cardNetworkName == null
                      ? null
                      : CardNetwork.values.byName(cardNetworkName),
                ),
          ...
          case VaultItemType.certificate:
            final certificateFormatName =
                fields['certificateFormat'] as String?;
            ...
            await certificateItemsDao.upsertCertificateItem(
              CertificateItemsCompanion(
                ...
                certificateFormat: Value(
                  certificateFormatName == null
                      ? null
                      : CertificateFormat.values.byName(certificateFormatName),
                ),
                ...
                keyAlgorithm: Value(
                  keyAlgorithmName == null
                      ? null
                      : CertificateKeyAlgorithm.values.byName(keyAlgorithmName),
                ),
            ...
            await contactItemsDao.upsertContactItem(
              ContactItemsCompanion(
                ...
                isEmergencyContact: Value(
                  fields['isEmergencyContact'] as bool? ?? false,
                ),
              ),
            );
            break;
            ...
            await cryptoWalletItemsDao.upsertCryptoWalletItem(
              CryptoWalletItemsCompanion(
                ...
                walletType: Value(
                  walletTypeName == null
                      ? null
                      : CryptoWalletType.values.byName(walletTypeName),
                ),
                walletTypeOther: Value(fields['walletTypeOther'] as String?),
                network: Value(
                  networkName == null
                      ? null
                      : CryptoNetwork.values.byName(networkName),
                ),
                ...
                derivationScheme: Value(
                  derivationSchemeName == null
                      ? null
                      : CryptoDerivationScheme.values.byName(
              ...
              LicenseKeyItemsCompanion(
                ...
                licenseType: Value(
                  licenseTypeName == null
                      ? null
                      : LicenseType.values.byName(licenseTypeName),
                ),
              ...
              LoyaltyCardItemsCompanion(
                ...
                barcodeType: Value(
                  barcodeTypeName == null
                      ? null
                      : LoyaltyBarcodeType.values.byName(barcodeTypeName),
                ),
          ...
          case VaultItemType.otp:
            await otpItemsDao.upsertOtpItem(
              OtpItemsCompanion(
                itemId: Value(snapshot.itemId),
                type: Value<OtpType>(
                  OtpType.values.byName(fields['type'] as String),
                ),
                issuer: Value(fields['issuer'] as String?),
                accountName: Value(fields['accountName'] as String?),
                secret: Value<Uint8List>(fields['secret'] as Uint8List),
                algorithm: Value<OtpHashAlgorithm>(
                  OtpHashAlgorithm.values.byName(fields['algorithm'] as String),
                ),
            ...
            await sshKeyItemsDao.upsertSshKeyItem(
              SshKeyItemsCompanion(
                ...
                keyType: Value(
                  keyTypeName == null
                      ? null
                      : SshKeyType.values.byName(keyTypeName),
                ),
              ...
              WifiItemsCompanion(
                ...
                securityType: Value(
                  fields['securityType'] == null
                      ? null
                      : WifiSecurityType.values.byName(
                          fields['securityType'] as String,
                        ),
                ),
                ...
                encryption: Value(
                  fields['encryption'] == null
                      ? null
                      : WifiEncryptionType.values.byName(
                          fields['encryption'] as String,
                        ),
                ),
          ...
          case VaultItemType.file:
            ...
            if (fields['metadataHistoryId'] != null) {
              final metaHistory = await fileMetadataHistoryDao
                  .getFileMetadataHistoryById(
                    fields['metadataHistoryId'] as String,
                  );
              if (metaHistory != null) {
                ...
                await fileMetadataDao.upsertFileMetadata(
                  FileMetadataCompanion(
                    ...
                    lastIntegrityCheckAt: Value(
                      metaHistory.lastIntegrityCheckAt,
                    ),
                  ),
                );
              }

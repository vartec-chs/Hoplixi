...
final class DashboardV2FilterTabs extends ConsumerStatefulWidget {
  const DashboardV2FilterTabs({
    super.key,
    this.onTabChanged,
    this.height = 40,
  ...
  @override
  ConsumerState<DashboardV2FilterTabs> createState() =>
      _DashboardV2FilterTabsState();
}

final class _DashboardV2FilterTabsState
    extends ConsumerState<DashboardV2FilterTabs>
  ...
  void _onTabChanged() {
    ...
    logDebug(
      'DashboardV2FilterTabs: Изменена вкладка',

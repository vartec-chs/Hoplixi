...
Полнофункциональная форма создания хранилища с пошаговой валидацией и
анимациями.
...
1. **Изоляция состояния**: форма использует собственный провайдер, не влияет на
   глобальное состояние до создания
...
4. **Адаптивность**: использует theme colors для корректного отображения в
   светлой/темной теме

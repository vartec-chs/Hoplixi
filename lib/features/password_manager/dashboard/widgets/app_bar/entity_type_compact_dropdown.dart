...
final class DashboardEntityTypeCompactDropdown extends ConsumerWidget {
  const DashboardEntityTypeCompactDropdown({
    ...
    return Container(
      ...
      child: DropdownButton<EntityType>(
        ...
        onChanged: (newType) {
          ...
          logInfo(
            'DashboardEntityTypeCompactDropdown: Изменен тип сущности',

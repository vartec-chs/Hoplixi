...
final class DashboardSliverAppBar extends ConsumerStatefulWidget {
...
final class _DashboardSliverAppBarState
    extends ConsumerState<DashboardSliverAppBar> {
      ...
      actions: [
        if (widget.showEntityTypeSelector)
          Padding(
            ...
            child: DashboardEntityTypeCompactDropdown(
  ...
  Future<void> _openFilter() async {
    logInfo('DashboardSliverAppBar: Открытие фильтров');
  ...
  Future<void> _openStoreSettingsModal() async {
    logInfo('DashboardSliverAppBar: Открытие настроек хранилища');
    await showStoreSettingsModal(context);
  }

  Future<void> _openPinnedEntityTypesModal() async {
    logInfo('DashboardSliverAppBar: Открытие настроек типов записей');

...
import 'package:hoplixi/vault_db/core/scheme/tables/vault_items/vault_item_custom_fields_history.dart';

part 'vault_item_custom_fields_history_dao.g.dart';

@DriftAccessor(tables: [VaultItemCustomFieldsHistory])
class VaultItemCustomFieldsHistoryDao extends DatabaseAccessor<VaultDB>

...
import '../../../scheme/tables/document/document_pages_tables.dart';

part 'document_pages_dao.g.dart';

@DriftAccessor(tables: [DocumentPages])
class DocumentPagesDao extends DatabaseAccessor<VaultDB>
  ...
  Future<String> createDocumentPage({
    ...
    await into(documentPages).insert(
      DocumentPagesCompanion.insert(id: Value(pageId), documentId: documentId),
    );
    return pageId;
  }

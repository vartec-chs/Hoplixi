...
class VaultEntitiesApi {
  VaultEntitiesApi({
    ...
    required VaultRepositories repositories,
      ...
      otps =
          VaultEntityTypeApi<CreateOtpDto, PatchOtpDto, OtpViewDto, OtpCardDto>(
  ...
  >
  documents;
  final VaultEntityTypeApi<CreateFileDto, PatchFileDto, FileViewDto, FileCardDto>
  files;
  final VaultEntityTypeApi<
    CreateIdentityDto,
    PatchIdentityDto,
  ...
  >
  loyaltyCards;
  final VaultEntityTypeApi<CreateNoteDto, PatchNoteDto, NoteViewDto, NoteCardDto>
  notes;
  ...
  >
  sshKeys;
  final VaultEntityTypeApi<CreateWifiDto, PatchWifiDto, WifiViewDto, WifiCardDto>
  wifis;
}

...
import 'package:hoplixi/vault_db/core/validators/license_key_validator.dart';
      ...
      return await db.transaction(() async {
        ...
        if (createdView == null) {
          throw DBCoreError.notFound(
            entity: 'licenseKey',
            id: itemId,
            message: 'Failed to retrieve created LicenseKey: $itemId',
          );
        }
      ...
      return await db.transaction(() async {
        ...
        if (oldView == null) {
          throw DBCoreError.notFound(
            entity: 'licenseKey',
            id: itemId,
            message: 'LicenseKey not found for update: $itemId',
          );
        }

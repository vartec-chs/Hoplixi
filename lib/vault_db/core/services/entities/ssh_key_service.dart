...
import 'package:hoplixi/vault_db/core/validators/ssh_key_validator.dart';
      ...
      return await db.transaction(() async {
        ...
        final createdView = createdViewResult.getOrThrow().fold(
          ...
          () => throw DBCoreError.notFound(
            entity: 'sshKey',
            id: itemId,
            message: 'Failed to retrieve created SshKey: $itemId',
          ),
        );
      ...
      return await db.transaction(() async {
        ...
        if (oldView == null) {
          throw DBCoreError.notFound(
            entity: 'sshKey',
            id: itemId,
            message: 'SshKey not found for update: $itemId',
          );
        }

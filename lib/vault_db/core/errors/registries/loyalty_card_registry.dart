...
final Map<String, DbConstraintDescriptor> loyaltyCardRegistry = {
  ...
  LoyaltyCardItemConstraint.programNameNotBlank.constraintName:
      const DbConstraintDescriptor(
  ...
  LoyaltyCardItemConstraint.cardNumberNotBlank.constraintName:
      const DbConstraintDescriptor(
  ...
  LoyaltyCardItemConstraint.barcodeValueNotBlank.constraintName:
      const DbConstraintDescriptor(
  ...
  LoyaltyCardItemConstraint.validDateRange.constraintName:
      const DbConstraintDescriptor(

...
final Map<String, DbConstraintDescriptor> passwordRegistry = {
  PasswordItemConstraint.itemIdNotBlank.constraintName:
  ...
  PasswordItemConstraint.loginNotBlank.constraintName:
      const DbConstraintDescriptor(
  ...
  PasswordItemConstraint.loginNoOuterWhitespace.constraintName:
      const DbConstraintDescriptor(
  ...
  PasswordItemConstraint.emailNotBlank.constraintName:
      const DbConstraintDescriptor(
  ...
  PasswordItemConstraint.emailNoOuterWhitespace.constraintName:
      const DbConstraintDescriptor(
  ...
  PasswordItemConstraint.passwordNotBlank.constraintName:
      const DbConstraintDescriptor(
  ...
  PasswordItemConstraint.urlNotBlank.constraintName:
      const DbConstraintDescriptor(
  ...
  PasswordItemConstraint.urlNoOuterWhitespace.constraintName:
      const DbConstraintDescriptor(

...
/// Сервис создания SQLite3 Multiple Ciphers-подключения для VaultDB.
class VaultDBConnectionService {
  static const String _logTag = 'VaultDBConnectionService';

  AsyncResultDart<VaultDB, AppError> createDatabaseConnection(
    String dbFilePath,
    String pragmaKey, {
    ...
    try {
      ...
      final database = VaultDB(executor);

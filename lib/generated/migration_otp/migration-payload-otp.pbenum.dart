...
//
// Generated from migration-payload-otp.proto.
...
class MigrationPayload_Algorithm extends $pb.ProtobufEnum {
  ...
  static final $core.List<MigrationPayload_Algorithm?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 4);
  static MigrationPayload_Algorithm? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class MigrationPayload_DigitCount extends $pb.ProtobufEnum {
  ...
  static final $core.List<MigrationPayload_DigitCount?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static MigrationPayload_DigitCount? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class MigrationPayload_OtpType extends $pb.ProtobufEnum {
  ...
  static final $core.List<MigrationPayload_OtpType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static MigrationPayload_OtpType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

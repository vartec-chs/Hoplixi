...
const String storeMigrationRequiredCode = 'DB_STORE_MIGRATION_REQUIRED';
const String storeVersionTooNewCode = 'DB_STORE_VERSION_TOO_NEW';

bool isStoreMigrationRequiredError(DatabaseError? error) {
  return error?.code == storeMigrationRequiredCode;
}
...
String _buildMigrationDescription(DatabaseError? error) {

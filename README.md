...
3. При необходимости включите биометрию, PIN и авто-блокировку
4. Добавьте первые записи, категории, теги и иконки
5. При желании подключите cloud sync для snapshot-синхронизации vault

...
store_manifest.json). store_manifest.json - содержит метаданные хранилища (uuid,
дату обновления). store_name.hplxdb - зашифрованная база данных SQLite3 Multiple

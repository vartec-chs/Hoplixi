...
void main() {
  ...
  group('ApiKeyService', () {
    ...
    test('historyEnabled=false returns failure if action requires snapshot', () async {
      ...
      final dto = CreateApiKeyDto(
        item: const VaultItemCreateDto(name: 'No History'),
        apiKey: const ApiKeyDataDto(service: 'S', key: 'K'),
      );
      ...
      final snapshotCount = await dataFactory.countTable(db.vaultSnapshotsHistory);
